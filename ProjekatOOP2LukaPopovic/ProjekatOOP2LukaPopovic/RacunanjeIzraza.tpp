...
string concat(string& a, string& b, char op) {
    //vraca vrednost stringa 
    //string(1,op) vraca jedan operator
    //naprimer +,-
    // da je pisalo string(2,op) ispisalo bi 2 stringa
...
//kada se ucita iz fajla vrednosti se stavljaju u globalnu promenjivu
template<typename T>
void read_ucitaj() {
...
//funkcija koja je glavna i u njoj se sve desava
template<typename T>
void solve() {
    redni_broj_ucitano++;
    //sortiranje
    //vektor brojeva su brojevi s kojim treba da se nadje resenje
    //prave se permutacije
...
//funkcija koja cuva izraz jer mi treba kada upisujem u Rezultati.txt
